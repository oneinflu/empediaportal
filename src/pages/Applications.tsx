...
export default function Applications() {
      ...
      try {
        ...
        if (isAdmin) {
          try {
            ...
            data = await applicationService.getAllApplicationsAggregated();
          }
        } else {
  ...
  return (
    <>
      <PageMeta
        title="Applications | Empedia Admin"
        description="View job and internship applications"
      />
                  ...
                  {!isLoading && applications.map((app) => {
                    const companyName =
                      typeof app.job?.company === "object"
                        ? ((app.job?.company as { company_name?: string })?.company_name || "Unknown Company")
