    ...
    <div className="w-full">
      ...
      <div className={`relative inline-block w-full ${isOpen ? "z-50" : "z-20"}`}>
        <div className="relative flex flex-col items-center">
          ...
          {isOpen && (
            <div
              className="absolute left-0 z-40 w-full overflow-y-auto bg-white dark:bg-gray-900 rounded-lg shadow-lg top-full max-h-select border border-gray-200 dark:border-gray-700 mt-1"
            ...
            >
              ...
              <div className="flex flex-col">
                {filteredOptions.length > 0 ? (
                    ...
                    <div
                        key={index}
                        className={`hover:bg-primary/5 w-full cursor-pointer border-b border-gray-100 dark:border-gray-800 last:border-0`}
                        onClick={() => handleSelect(option.value)}
                    >
                        <div
                        className={`relative flex w-full items-center p-2 pl-2 ${
                            selectedOptions.includes(option.value)
                            ? "bg-primary/10 text-brand-600 dark:text-brand-400"
